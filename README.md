...
**モノを渡すのも、手伝ってもらうのも、結局は「今ここにいる、特定の相手」を見つけないと成立しません。** そんな相手を、学内限定で見つけるためのタイムラインです。

教科書を売りたい人、引越しを手伝ってほしい人。大学の中にはこうした要求が常にありますが、今は繋がる場所がありません。SNSでは学外の人にまで届いてしまい、掲示板は誰も見ていない。
...
**モノを渡すのも、困りごとを手伝ってもらうのも、結局は「今ここにいる、特定の相手」を見つけないと成立しません。** 教科書は誰かの本棚にあり、手伝える人はどこかにいます。足りないのは中身ではなく、**その人を見つける仕組み**です。

これは既存サービスが弱いところでもあります。メルカリは相手が誰か分からないままでも成立しますが、教科書の受け渡しや力仕事の依頼は、相手が「今ここにいる、身元の分かる人」でなければ成立しません。学内という条件がそのまま強みになる領域に絞っています。
...
|  | モノ | 手伝い |
|---|---|---|
| **提供します** | 微積の教科書（800円） | 引越し手伝います |
| **求めています** | 統計の教科書を探しています | 実験の記録係を1名 |

この4マスで、教科書の売買も、困りごとの相談もすべて表現できます。

### なぜこうするのか

**理由1：作る量が4分の1になる。** 投稿フォームも一覧画面も1つで済みます。限られた期間の中で、中身の質に時間を使えます。
...
最初は「留学の体験談」「教職課程の実態」のような、質問や体験談を共有するマスもありました。検討の結果、削りました。

モノと手伝いは、**学内で身元が分かり、直接会えること**が価値になります。一方で情報のやり取りは、その価値が一番弱いマスでした。留学の体験談は学内のX（旧Twitter）アカウントやLINEグループでも案外足りますし、答える側にとって「同じ大学の学生である」ことの意味もそこまで大きくありません。

「課題が何のアプリか分かりにくい」という指摘を受け、**学内である必然性が一番弱いマスから削る**という基準で絞りました。ラベルとしての「関心」（留学・教員志望など）は引き続き人に付けられます。人と人を繋ぐための照準として使う分には有効なので、そちらは残しています。
...
統計学・データ構造・微積といった履修科目のラベルには、試験の有無・授業計画・成績評価の方法などの**授業情報**が付いています。大学からのお知らせ（§6）と同じ**固定のサンプルデータ**で、学生が書き込んで更新する機能は作っていません。§5 の「ラベルを探す」欄で、その科目のラベルを選ぶとカードが表示されます。

---

## 5. 画面はどう見えるか

画面は**1つ**です。上部にラベルのボタンが並び、下に投稿が「提供します」「求めています」の2つに分かれて流れます。
...
「🔍 ラベルを探す」は、開閉できる欄です。**別画面ではなく、この1つの画面の中で開いたり閉じたりするだけ**なので、「画面は1つ」の原則は崩れません。

- カテゴリ（学部・学年・履修科目・課外活動・関心・キャンパス）ごとに見出しが付き、ラベルが増えても迷わず探せます
- キーワードを入力すると、その名前を含むラベルだけに絞れます
- 履修科目のラベルを選ぶと、そのすぐ下に授業情報のカードが表示されます
...
3. **「情報」のマスは自分たちで削った** ── 「課題が不明確」という指摘を受け、学内である必然性が一番弱いマスから絞り込んだ判断を説明します
...
| COURSE_INFO | 履修科目ラベルに付く授業情報。試験の有無・授業計画など。固定サンプルで編集機能はない |

### この形にした理由

**理由1：投稿の表は1つだけ。** フリマ用・お知らせ用の表を分けていません。§3 の「投稿は1種類だけ、違うのはラベルだけ」という判断が、そのまま POST という1つの表になっています。4マスの分類は `direction`（提供する／求める）と `kind`（モノ／手伝い）の2つの列で表します。
